...
<div className="flex flex-col items-start gap-8  lg:gap-4    bg-[#efeae8] flex-1 pl-48  shrink-0  4xl:pl-72  lg:pl-10   lg:relative lg:z-20 sm:px-4 sm:w-full  sm:pr-48 dxs:pr-4   ">
    <div>
<h1 className="text-5xl text-grey  2xl:text-4xl  xs:text-2xl  text-darkBrown  rust macho md:text-[26px]  dxs:leading-none">Hello, Darlington here<span className="text-6xl  lg:text-3xl">.</span></h1>
...
Junior Frontend Web Developer | HTML, Css, TailwindCSS, Reactjs, TypeScript,   Javascript MERN stack, Remix, Nextjs, MongoDB, Xata, Cloudinary.
</p>
<div className="flex gap-4 items-center  sm:justify-center">
    
<Button classic to="/works" action="See my works"/>
<Button mustard  to="/" action="My Résumé"/>
</div>
</div>
